...
<label style="font-size: 12px" for="dni" class="col-md-1 control-label">DNI</label>
      ...
      <div class="form-group row" >
	<label style="font-size: 12px" for="conductor" class="col-md-1 control-label">Conductor</label>
	<div class="col-md-3">
		<input style="width: 150px" type="text" class="form-control input-sm" id="conductor" value="" name="conductor">
	</div>
...
<label style="font-size: 12px" for="tel2" class="col-md-1 control-label">Pago</label>
	<div class="col-md-3">
